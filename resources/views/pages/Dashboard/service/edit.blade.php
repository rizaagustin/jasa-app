                    ...
                    <form action="{{ route('member.service.update', [$service->id]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="">
                            <div class="px-4 py-5 sm:p-6">  
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 -mb-6">
                                        ...
                                        <label for="revision & limit" class="block mb-3 font-medium text-gray-700 text-md">Estimasi Service & Jumlah Revisi</label>
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <select id="revision_limit" name="revision_limit" autocomplete="revision_limit" class="block w-full px-3 py-3 pr-10 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                            ...
                                            <option value="2" {{ $service->revision_limit == '2' ? 'selected' : '' }}>5 Revisi</option>
                                        ...
                                        <div class="grid grid-cols lg:grid-cols-3 md:grid-cols-2 gap-4">
                                            @forelse($thumbnail_service as $thumbnail_item)
                                                <div class="mb-2">
                                                    ...
                                                    <input placeholder="Thumbnail" type="file" name="{{ 'thumbnails['.$thumbnail_item->id.']' }}" id="thumbnails" autocomplete="thumbnails" class="block w-full py-3 pl-5 mt-3 broder-gray-300 rounded-md shadow-sm focus:ring-green-500 sm:text-sm">
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        <label for="service-name" class="block mb-3 font-medium text-gray-700 text-md">Keunggulan kamu</label>
                                            ...
                                            @forelse($advantage_user as $advantage_user_item)
                                                <input placeholder="Keunggulan Kamu" type="text" name="{{ 'advantage-users['.$advantage_item->id.']'}}" id="advantage-users" autocomplete="advantage-users" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $advantage_user_item->advantage ?? '' }}" required>        
                                            @empty
                                                {{-- empety --}}
                                            @endforelse
                                    ...
                                    <div class="col-span-6">
                                        ...
                                        @forelse($tagline as $tagline_item)
                                            <input placeholder="Tagline" type="text" name="{{ 'taglines['.$advantage_item->id.']'}}" id="taglines" autocomplete="taglines" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $tagline_item->tagline ?? '' }}" required>        
                                        @empty
                                            {{-- empety --}}
                                        @endforelse                                   
                            ...
                            <div class="px-4 py-3 text-right sm:px-6">
                                ...
                                <a href="{{ route('member.service.index') }}" type="button" class="inline-flex justify-center px-4 py-2 mr-4 text-sm font-medium text-gray-700 bg-white border border-gray-600 rounded-lg shadow-sm hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300" onclick="return confirm('Are you sure wan to cancel?, Any changes you make will not be saved')">
                                    Cancel
                                </a>
...
<script type="text/javascript">
    ...
    $("#addServicesRow").click(function() {
        var html = '';
        html += '<input placeholder="Keunggulan Service" type="text" name="advantage_service[]" id="advantage_service" autocomplete="advantage_service" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>';
